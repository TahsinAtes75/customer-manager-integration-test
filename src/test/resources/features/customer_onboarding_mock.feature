Feature: Customer Onboarding
  ...
  Scenario: Capture Email - Happy Path
    ...
    And I set request body with information given in the following table
      | email    | sample1@trial.com |
      | make     | Apple             |
      | model    | iphone7           |
      | serialNo | 123456            |
    When I POST request to "/v1/customers"
    Then response status code should be 200
    And response body should contain value of "sample1@trial.com" for key "email"
  ...
  Scenario Outline: Capture Email - Input Validation Test
    ...
    Examples:
      ...
      | sdfhghg                       | Apple                 | iphone7               | AB123                 | field     | Field is invalid |
      |                               | Apple                 | iphone7               | AB123                 | field     | Field is invalid |
      | a@b.c                         | Apple                 | iphone7               | AB123                 | field     | Field is invalid |
      | adfsdfsfkhsjfkhsj@bfsfsdf.com | Apple                 | iphone7               | AB123                 | field     | Field is invalid |
      | ebru@trial.com                |                       | iphone7               | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | A                     | iphone7               | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | Ahasd123gs/sdenfrhdrd | iphone7               | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | Apple                 |                       | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | Apple                 | 1                     | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | Apple                 | Abcde123456/+asdfghjk | AB123                 | field     | Field is invalid |
      | ebru@trial.com                | Apple                 | iphone7+              |                       | field     | Field is invalid |
      | ebru@trial.com                | Apple                 | iphone7+              | A                     | field     | Field is invalid |
      | ebru@trial.com                | Apple                 | iphone7+              | Abcde12345u6/+wertyuk | field     | Field is invalid |
  ...
  Scenario Outline: Verify Email - Input Validation Test
    ...
    Examples:
      | tokenValue                                          | emailValue  | fieldName | message          |
      |                                                     | asd@asd.com | field     | Field is invalid |
      | asd                                                 | asd@asd.com | field     | Field is invalid |
      | asd123asd123asd123asd123asd123asd123asd123asd123asd | asd@asd.com | field     | Field is invalid |
